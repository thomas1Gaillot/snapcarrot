...
import {FigmaIcon, PiggyBankIcon, RabbitIcon} from "lucide-react";
...
export function BentoGridThirdDemo() {
    ...
    const items = [
        ...
        {
            title: "Regroup your UI",
            description: (
                <span className="text-sm">
        Incoming project that will revolutionize the way you create your UI.
      </span>
            ),
            header: <SkeletonFour/>,
            className: "md:col-span-2",
            icon: <IconSignature className="h-4 w-4 text-neutral-500"/>,
            onClick: () => router.push("/centralized-app")
...
const SkeletonFour = () => {
    ...
    return (
        ...
        >
            ...
            >
                <FigmaIcon className="h-8 w-8 text-neutral-500"/>
            ...
            <motion.div
                ...
                <RabbitIcon className="h-8 w-8 text-neutral-500"/>
            ...
            <motion.div
                ...
                className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
            >
                <PiggyBankIcon className="h-8 w-8 text-neutral-500"/>

                <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
                    {"Let's pay for something pixel perfect"}
                </p>
